...
import { FaGlobeAsia ,FaApple, FaAirbnb,FaEye} from 'react-icons/fa';
...
const features = [
  {
    name:"hello",
    description:"Kepp all your PDF files securey stored and easily accessible anytime, anywhere",
    icon:FaGlobeAsia
  },
